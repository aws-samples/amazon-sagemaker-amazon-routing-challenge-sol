...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="data/Final_March_15_Data", 
                        help="`Final_March_15_Data` is for training, and `Final_June_18_Data` is for evaluation")
    ...
    if "gen_route" == args.act:
        ...
        print("Travel Time file read")
        gen_distance_matrix(
            df_r, df_t, out_dir=os.path.join(DATA_DIR, "distance_matrix"), include_station=True, add_softmax=False
        )
    elif "gen_zone_list" == args.act:
        gen_zone_list(df_r, out_dir=os.path.join(DATA_DIR, "zone_list"))
